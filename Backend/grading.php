...
//Execute SQL to get point values for each question on the exam
$sql5 = "SELECT PointValue FROM Exams WHERE ExamName = '$examName'";
$$result3 = mysqli_query($conn, $sql0);

while ($row = mysqli_fetch_assoc($result3)){
	$PointsVar[] = $row; //insert all the questions & info to an array
}

array_push($finalResult, $PointsVar;
